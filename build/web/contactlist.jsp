...
Class.forName("com.mysql.jdbc.Driver");
    ...
    ResultSet rcon=st.executeQuery("select * from contactus");
	...
	while(rcon.next())
{
  ...
  <tr>
	...
	<td><%=rcon.getString("mobile")%></td>
    <td><%=rcon.getString("email")%></td>
	<td><%=rcon.getString("subject")%></td>
    <td><%=rcon.getString("message")%></td>

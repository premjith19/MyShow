...
<body>
    ...
    ResultSet rs=st.executeQuery("select * from movie where mname like '%"+search+"%' or lang like '%"+search+"%' order by rdate desc");
...
%>
				<div class="person-grid">
					<div class="person-img">
						<a href="#"><img src="<%=rs.getString("poster")%>" title="actor" style="width:62px;height:88px;"></a>
					</div>
					<div class="person-details">
						<a href="#"><%=rs.getString("mname")%></a>
						<p><%=rs.getString("lang")%></p>
						<p><%=rs.getString("genre")%></p>
						<a href="moviesingle.jsp?mid=<%=rs.getString("mid")%>"><h6>Synopsis</h6></a>
					</div>

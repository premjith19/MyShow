...
<html>
<head>
<title>My Show a Entertainment Category Flat Bootstarp responsive Website Template | write-us :: w3layouts</title>
...
<%
    ...
    ResultSet rp=st.executeQuery("select * from user where fname='"+session.getAttribute("username")+"'");
	...
	while(rp.next())
	{
        fname=rp.getString("fname");
		        email=rp.getString("email");
				       mobile=rp.getString("mobile");
								image=rp.getString("image");
								lname=rp.getString("lname");
								dob=rp.getString("dob");
	...
	<div class="blog-section">
		<div class="col-md-8 write-us">
			<h3 class="post"><%=fname%></h3><br>
			<h4 class="post"><%=email%></h4><br>
			<h5 class="post"><%=mobile%></h5>
			
				<img src="<%=image%>" style="width:300px;height:350px;" alt="" />
  ...
  <tr>
    <td>Gender</td>
    <td><input type="radio" name="sex" value="Male">Male<input type="radio" name="sex" value="Female">Female</td><br>
  </tr>
  <tr>
    <td>Date of Birth</td>

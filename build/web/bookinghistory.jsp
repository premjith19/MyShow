...
<!-- AddThis Smart Layers END -->
	...
	<!----->
	<div class="person">
		<h3>Biography of Famous Actors, Actresses and Directors</h3>
	...
	Class.forName("com.mysql.jdbc.Driver");
       Connection conhi=DriverManager.getConnection("jdbc:mysql://localhost/cinema","root","");
	

			    Statement stu = conhi.createStatement();
    
				ResultSet rhu=stu.executeQuery("select * from user where fname='"+session.getAttribute("username")+"'");
				rhu.next();
				String uid=rhu.getString("uid");

				out.print(uid);
			    Statement sthis = conhi.createStatement();
    
				ResultSet rhis=sthis.executeQuery("select * from ticketbook where uid="+uid);
				...
				while(rhis.next())
				{
					String sid=rhis.getString("sid");
				out.print(sid);
				Statement sthmo = conhi.createStatement();
    
				ResultSet rhmo=sthmo.executeQuery("select * from schedule where sid='"+rhis.getString("sid")+"'");
				if(rhmo.next())
				{
				while(rhmo.next())
				{
					Statement sthmov = conhi.createStatement();
    
				ResultSet rhmov=sthmov.executeQuery("select * from movie where mid='"+rhmo.getString("mid")+"'");
				...
				<div class="person-grid">
					<div class="person-img">
						<a href="#"><img src="<%=rhmov.getString("poster")%>" style="width:62px;height:88px;" title="actor"></a>
					</div>
					<div class="person-details">
						<a href="#"><%=rhmov.getString("mname")%></a>
											
						<p><%=rhmo.getString("sdate")%></p>
						<p><%=rhis.getString("qty")%></p>
						<p><%=rhis.getString("amount")%></p>
			...
			<div class="col-md-6 person-grids-right">
				...
				<div class="person-grid">
					<div class="person-img">
						<a href="#"><img src="images/75x75.jpg" title="actor"></a>
					</div>
					<div class="person-details">
